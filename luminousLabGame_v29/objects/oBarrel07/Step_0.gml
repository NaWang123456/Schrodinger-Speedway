...
if (is_active) {
    ...
    path_position += speed / path_get_length(path_barrel07);
    ...
    var current_x = path_get_x(path_barrel07, path_position);
    var current_y = path_get_y(path_barrel07, path_position);
    ...
    var next_x = path_get_x(path_barrel07, next_position);
    var next_y = path_get_y(path_barrel07, next_position);
